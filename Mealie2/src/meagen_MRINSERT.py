...
"""
   ...
   for this_row in range(start_row, wsh.nrows):
      ...
      ofh.write("INSERT INTO maximo.mrstatus (")
      ofh.write("mrnum,status,changedate,changeby,memo,maximo.mrstatusseq,orgid,siteid) ")
      ...
      ofh.write("VALUES('%s', 'CAN',sysdate,'ASTPM14','',maximo.mrstatusseq.nextval,'170','PMB')" %
               (itemnum))
      ofh.write("\n/\n")
